...
var KTUsersUpdatePermission = function () {
    ...
    var initUpdatePermission = () => {
        ...
        closeButton.addEventListener('click', e => {
            e.preventDefault();
            var emptyVal=$("#kt_modal_update_permission_form input").filter(function () {
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        axios.post("menu-update", {
                            title: form.querySelector('[name="permission_name_edit"]').value,
                            url: form.querySelector('[name="permission_url_edit"]').value,
                            id: form.querySelector('[name="permission_id"]').value
                        }).then(function (response) {
                            console.log(response.data);
                            if (response.data.status) {
                                form.querySelector('[name="permission_name_edit"]').value = "";
                                form.querySelector('[name="permission_url_edit"]').value = "";
                                form.querySelector('[name="permission_id"]').value = "";
                                Swal.fire({

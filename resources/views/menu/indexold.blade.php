							...
							<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
								...
								<form id="kt_modal_update_permission_form" class="form" action="#">
									...
									<div class="fv-row mb-7">
										...
										<!--end::Label-->
										<!--begin::Input-->
										<input class="form-control form-control-solid" placeholder="Enter a permission url" name="permission_url" />
										<!--end::Input-->
									</div>
									<!--end::Input group-->
									<!--begin::Actions-->
...
<script>
	$('.kt_modal_update_permission').click(function() {
		...
		$('[name="permission_name"]').val($(this).data('details').menu_name);
		$('[name="permission_url"]').val($(this).data('details').url);

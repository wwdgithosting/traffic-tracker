        ...
        <div class="performance-statistics">
            ...
            <div class="add-employee">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="row mb-3">
                            <label for="inputEmail3" class="col-sm-4 col-form-label">Employee Id<span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="row mb-3">
                            <label for="inputEmail3" class="col-sm-4 col-form-label">Email address<span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                        ...
                        <div class="row mb-3">
                            <label for="phone" class="col-sm-4 col-form-label">Phone No<span class="text-danger">*</span></label>
                            <div class="col-sm-8">
            ...
            <div class="add-employee">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="row mb-3">
                            <label for="inputEmail3" class="col-sm-4 col-form-label">Date of Joining<span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-4 col-form-label">Employee Status<span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                        ...
                        <div class="row mb-3">
                            ...
                            <label class="col-sm-4 col-form-label">Employee Designation<span class="text-danger">*</span></label>
                            ...
                            <div class="col-sm-8">
                                <select class="form-select" name="current_shift" aria-label="" id="user_shift_id">
                                    ...
                                    @forelse ($shiftTypes as $result)
                                        <option value="{{ $result->id}}" >{{ $result->shift_title }}</option>
                                    @empty
            ...
            <div class="add-employee">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="row mb-3">
                            <label class="col-sm-4 col-form-label">Reporting Manager<span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                                <select class="form-select" name="reporting_manager_id" aria-label="">
                                    <option value="">Select Manager</option>
                                    @forelse ($managers as $manager)
                                        <option value="{{ $manager->id }}" @if(old('reporting_manager_id')== $manager->id ) selected @endif >@php if($manager->user_type_id == 1){ $usertype = " (Admin/HR)";} if($manager->user_type_id == 2){ $usertype = " (RO)";} if($manager->user_type_id == 4){ $usertype = " (Unit Head)";} @endphp {{ $manager->fullname }}</option>
                                        @empty
                                    @endforelse
                                </select>
                            </div>

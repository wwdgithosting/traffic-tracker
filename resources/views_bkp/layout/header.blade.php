            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img src="{{(auth()->user()->profile_image !='' ) ? url('/').'/uploads/photos/'.auth()->user()->profile_image : asset('assets/media/avatars/blank.png')}}" alt="user" />
                    </div>
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="{{(auth()->user()->profile_image !='' ) ? url('/').'/uploads/photos/'.auth()->user()->profile_image : asset('assets/media/avatars/blank.png')}}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
...
<script>
    $(document).ready(function() {
        $(document).on('click', '.update-user-profile', function() {
            ...
            var imageUrl = (details.profile_image != null) ? '/uploads/photos/' + details.profile_image : 'assets/media/avatars/blank.png';

<div id="kt_app_header" class="app-header">
    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="jkavascript:void(0)" class="d-lg-none">
            ...
            <div class="app-navbar flex-shrink-0">
                        ...
                        <div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
                            ...
                            <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-sm fw-bold btn-primary" data-kt-search-element="advanced-options-form-search">Search</a>
                                </div>
                                <!--end::Actions-->
                            </form>
                            <!--end::Preferences-->
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img src="{{(auth()->user()->profile_image !='' ) ? url('/').'/public/uploads/photos/'.auth()->user()->profile_image : asset('assets/media/avatars/blank.png')}}" alt="user" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="{{(auth()->user()->profile_image !='' ) ? url('/').'/public/uploads/photos/'.auth()->user()->profile_image : asset('assets/media/avatars/blank.png')}}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="javascript:void(0)" class="menu-link px-5 update-user-profile" data-details="{{auth()->user()}}">Account Settings</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
...
<div class="modal fade" id="kt_modal_update_user_profile" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header" id="kt_modal_update_user_profile_header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Add User</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-icon-primary form-cancel">
                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                    <span class="svg-icon svg-icon-1">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="currentColor" />
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <form id="kt_modal_update_user_profile_form" class="form" action="#" enctype="multipart/form-data">
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_user_profile_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_user_profile_header" data-kt-scroll-wrappers="#kt_modal_update_user_profile_scroll" data-kt-scroll-offset="300px">
                        <div class="fv-row mb-7">
                            ...
                            <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                                ...
                                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change avatar">
                                    ...
                                    <input type="file" name="uavatar" accept=".png, .jpg, .jpeg" />
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="hidden" name="uuserid" id="uuserid" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Full name" value="0" />
                            <input type="text" name="ufirstname" id="ufirstname" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Full name" value="" />
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="ulastname" id="ulastname" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Full name" value="" />
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="password" name="upassword" id="upassword" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="********" value="" />
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="password" name="c_password" id="c_password" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="********" value="" />
                    ...
                    <div class="text-center pt-15">
                        <button type="reset" class="btn btn-light me-3 form-cancel">Discard</button>
...
<script>
    $(document).ready(function() {
        $(document).on('click', '.update-user-profile', function() {
            var details = $(this).data('details');
            var imageUrl = (details.profile_image != null) ? '/public/uploads/photos/' + details.profile_image : 'public/assets/media/avatars/blank.png';
            $('#ufirstname').val(details.firstname);
            $('#ulastname').val(details.lastname);
            $('#uuserid').val(details.id)
            $('.image-input-wrapper').removeAttr("style");
            $('.image-input-wrapper').css("background-image", "url(" + imageUrl + ")");
            $('#kt_modal_update_user_profile').modal('show');
        })
        $(document).on('click', '.form-cancel', function() {
            $('#kt_modal_update_user_profile').modal('hide');
        })

        $(document).on('click', '.update-user', function() {

            const element = document.getElementById('kt_modal_update_user_profile');
            const form = element.querySelector('#kt_modal_update_user_profile_form');
            ...
            $.ajax({
                type: 'POST',
                url: "https://dash.traffktrackr.com/user-update",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,

						...
						<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
							...
							<tbody class="fw-semibold text-gray-600">
								...
								<tr>
									<td>{{$org->id}}</td>
									<td>
										<a href="javascript:void(0)" class="text-gray-800 text-hover-primary mb-1 edit-org" data-details="{{$org}}">{{$org->org_name}}</a>
									</td>
										...
										<a href="#" class="btn btn-sm btn-light btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
												...
												<div class="menu-item px-3">
													<a href="javascript:void(0)" class="menu-link px-3 edit-org" data-details="{{$org}}">Edit</a>
												</div>
						...
						<div class="modal-content">
							...
							<form class="form" action="#" id="kt_modal_add_customer_form" data-kt-redirect="#">
								...
								<div class="modal-header" id="kt_modal_add_customer_header">
									<!--begin::Modal title-->
									<h2 class="fw-bold">Add/Edit Organization</h2>
									<!--end::Modal title-->
									<!--begin::Close-->
								...
								<div class="modal-body py-10 px-lg-17">
									...
									<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
										<input type="text" class="form-control form-control-solid" placeholder="" name="orgid" id="orgid" value="0" style="display:none" />

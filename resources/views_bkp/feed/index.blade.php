...
<script>
	...
	$(document).ready(function() {
		...
		$(document).on('click', '.del-row', function() {
			...
			$('#row-' + index).remove();
			$('#sub-row-' + index).remove();
			//$(this).closest(".add-sub-row").remove()
		})
		var s = 0;

											...
											<form id="kt_modal_add_user_form" class="form" action="#" enctype="multipart/form-data">
												<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
													...
													<div class="fv-row mb-7">
														...
														<input type="text" name="firstname" id="firstname" class="form-control form-control-solid mb-3 mb-lg-0 add-user-form-elem" placeholder="Full name" value="" />
													...
													<div class="fv-row mb-7">
														...
														<input type="text" name="lastname" id="lastname" class="form-control form-control-solid mb-3 mb-lg-0 add-user-form-elem" placeholder="Full name" value="" />
													...
													<div class="fv-row mb-7">
														...
														<input type="email" name="email" id="email" class="form-control form-control-solid mb-3 mb-lg-0 add-user-form-elem" placeholder="example@domain.com" value="" />
													...
													<div class="fv-row mb-7">
														...
														<select class="form-select form-control add-user-form-elem" name="company" id="company">
													...
													<div class="mb-7">
														...
														<div class="d-flex fv-row">
															...
															<div class="form-check form-check-custom form-check-solid">
																...
																<input class="form-check-input me-3 form-control add-user-form-elem" name="roles" type="radio" value="{{$role->id}}" id="kt_modal_update_role_option_{{$role->id}}" />
										...
										<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
											<a href="javascript:void(0)">
												<div class="symbol-label">
													<img src="{{($user->profile_image !='' ) ? url('/').'/uploads/photos/'.$user->profile_image : asset('assets/media/avatars/blank.png')}} " alt="{{$user->firstname.' '.$user->lastname}}" class="w-100" />
												</div>
											</a>
										</div>

										<div class="d-flex flex-column">
											<a href="javascript:void(0)" class="text-gray-800 text-hover-primary mb-1">{{$user->firstname.' '.$user->lastname}}</a>
...
<script>
	$(document).ready(function() {
		...
		$(document).on('click', '.edit-user', function() {
			...
			var imageUrl = (userData.profile_image != null) ? '/uploads/photos/' + userData.profile_image : 'assets/media/avatars/blank.png';

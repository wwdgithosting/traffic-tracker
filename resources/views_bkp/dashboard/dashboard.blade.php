  ...
  <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
      ...
      <div class="d-flex align-items-center gap-2 gap-lg-3">
        ...
        <a href="javascript:void(0)" class="btn btn-sm fw-bold btn-primary">New Shipment</a>
        <!--end::Primary button-->
      </div>
      <!--end::Actions-->
    </div>
          ...
          <div class="card bg-primary h-md-100" data-bs-theme="light">
            ...
            <div class="card-body d-flex flex-column pt-13 pb-14">
              ...
              <div class="text-center">
                ...
                <!--end::Link-->
                <!--begin::Link-->
                <a class="btn btn-sm bg-white btn-color-white bg-opacity-20" href="javascript:void(0)">Quick Guide</a>
                <!--end::Link-->
              </div>
              <!--end::Links-->
            </div>
        ...
        <div class="col-xl-4 mb-xl-10">
          ...
          <div class="card card-flush h-xl-100">
            ...
            <div class="card-header pt-7">
              ...
              <!--begin::Toolbar-->
              <div class="card-toolbar">
                <a href="#" class="btn btn-sm btn-light">Add Product</a>
              </div>
              <!--end::Toolbar-->
            </div>
            <!--end::Header-->
            ...
            <div class="card-body pt-0">
              ...
              <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-3">
                  <!--begin::Icon-->
                  <img src="{{asset('assets/media/stock/ecommerce/14.gif')}}" class="me-4 w-50px" alt="" />
                  <!--end::Icon-->
                  <!--begin::Section-->
                  <div class="flex-grow-1">
                    <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Fjallraven</a>
              ...
              <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-3">
                  <!--begin::Icon-->
                  <img src="{{asset('assets/media/stock/ecommerce/13.gif')}}" class="me-4 w-50px" alt="" />
                  <!--end::Icon-->
                  <!--begin::Section-->
                  <div class="flex-grow-1">
                    <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Nike AirMax</a>
              ...
              <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-3">
                  <!--begin::Icon-->
                  <img src="{{asset('assets/media/stock/ecommerce/41.gif')}}" class="me-4 w-50px" alt="" />
                  <!--end::Icon-->
                  <!--begin::Section-->
                  <div class="flex-grow-1">
                    <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Bose QC 35</a>
              ...
              <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-3">
                  <!--begin::Icon-->
                  <img src="{{asset('assets/media/stock/ecommerce/53.gif')}}" class="me-4 w-50px" alt="" />
                  <!--end::Icon-->
                  <!--begin::Section-->
                  <div class="flex-grow-1">
                    <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Greeny</a>
              ...
              <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-3">
                  <!--begin::Icon-->
                  <img src="{{asset('assets/media/stock/ecommerce/71.gif')}}" class="me-4 w-50px" alt="" />
                  <!--end::Icon-->
                  <!--begin::Section-->
                  <div class="flex-grow-1">
                    <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Apple Watches</a>
              ...
              <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-3">
                  <!--begin::Icon-->
                  <img src="{{asset('assets/media/stock/ecommerce/194.gif')}}" class="me-4 w-50px" alt="" />
                  <!--end::Icon-->
                  <!--begin::Section-->
                  <div class="flex-grow-1">
                    <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Friendly Robot</a>
